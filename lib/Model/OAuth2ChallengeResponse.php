...
/**
 * OAuth2ChallengeResponse Class Doc Comment
 *
 * @category Class
 * @package  Terapi\Client
 * @author   Terapi team
 * @link     https://github.com/terapi-integrations
 */
class OAuth2ChallengeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $TerapiModelName = 'OAuth2ChallengeResponse';
    ...
    protected static $TerapiTypes = [
        'success' => 'bool',
        'data' => 'AllOfOAuth2ChallengeResponseData',
        'error' => 'AllOfOAuth2ChallengeResponseError'
    ];
     ...
     * Gets data
     *
     * @return AllOfOAuth2ChallengeResponseData
     */
     ...
     * Sets data
     *
     * @param AllOfOAuth2ChallengeResponseData $data data
     *
     * @return $this
     */
     ...
     * Gets error
     *
     * @return AllOfOAuth2ChallengeResponseError
     */
     ...
     * Sets error
     *
     * @param AllOfOAuth2ChallengeResponseError $error error
     *
     * @return $this
     */

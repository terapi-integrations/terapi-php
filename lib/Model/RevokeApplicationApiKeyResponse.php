...
/**
 * RevokeApplicationApiKeyResponse Class Doc Comment
 *
 * @category Class
 * @package  Terapi\Client
 * @author   Terapi team
 * @link     https://github.com/terapi-integrations
 */
class RevokeApplicationApiKeyResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $TerapiModelName = 'RevokeApplicationApiKeyResponse';
     ...
     * Gets error
     *
     * @return AllOfRevokeApplicationApiKeyResponseError
     */
     ...
     * Sets error
     *
     * @param AllOfRevokeApplicationApiKeyResponseError $error error
     *
     * @return $this
     */

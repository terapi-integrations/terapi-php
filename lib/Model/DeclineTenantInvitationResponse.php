...
/**
 * DeclineTenantInvitationResponse Class Doc Comment
 *
 * @category Class
 * @package  Terapi\Client
 * @author   Terapi team
 * @link     https://github.com/terapi-integrations
 */
class DeclineTenantInvitationResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $TerapiModelName = 'DeclineTenantInvitationResponse';
     ...
     * Gets error
     *
     * @return AllOfDeclineTenantInvitationResponseError
     */
     ...
     * Sets error
     *
     * @param AllOfDeclineTenantInvitationResponseError $error error
     *
     * @return $this
     */

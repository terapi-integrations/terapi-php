...
/**
 * ApplicationListDto Class Doc Comment
 *
 * @category Class
 * @package  Terapi\Client
 * @author   Terapi team
 * @link     https://github.com/terapi-integrations
 */
class ApplicationListDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $TerapiModelName = 'ApplicationListDto';
    ...
    protected static $TerapiTypes = [
        'dtos' => '\Terapi\Client\Model\ApplicationDto[]'
    ];
    ...
    {
        $this->container['dtos'] = isset($data['dtos']) ? $data['dtos'] : null;
    }
     ...
     * Gets dtos
     *
     * @return \Terapi\Client\Model\ApplicationDto[]
     */
    public function getDtos()
    {
        return $this->container['dtos'];
    }

    /**
     * Sets dtos
     *
     * @param \Terapi\Client\Model\ApplicationDto[] $dtos dtos
     *
     * @return $this
     */
    public function setDtos($dtos)
    {
        $this->container['dtos'] = $dtos;

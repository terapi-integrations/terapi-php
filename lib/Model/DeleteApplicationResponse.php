...
/**
 * DeleteApplicationResponse Class Doc Comment
 *
 * @category Class
 * @package  Terapi\Client
 * @author   Terapi team
...
class DeleteApplicationResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $TerapiModelName = 'DeleteApplicationResponse';
     ...
     * Gets error
     *
     * @return AllOfDeleteApplicationResponseError
     */
     ...
     * Sets error
     *
     * @param AllOfDeleteApplicationResponseError $error error
     *
     * @return $this
     */
